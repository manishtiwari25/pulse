...
| 2026-08-11 | 39c58803 | gpt-5-mini, gpt-5.6-sol (GitHub Copilot) | n/a in / 88,225 out / n/a total @ 08:35 CEST † | n/a | Rebrand and publish PULSE, add the shared audit trail story, switch usage to tokens only, and deliver scoped agent-driven rollback planning and recovery. |
